...
final class DwFeedRegistry {
    ...
    static void create(String id,String page,int width,int height,int density,Surface output,Messenger reply){
        ...
        // V3: no optional flags. A zero-flag display is private and own-content-only by default.
        // This removes presentation/own-content flag permission ambiguity on Android 16.
        try{
        ...
        }catch(Throwable t){fail(s,"activity_launch_failed:"+describe(t));return;}
    ...
    private static String describe(Throwable t){
        ...
        String type=t.getClass().getSimpleName();String msg=t.getMessage();
